...
# Required Configs I added
parser.add_argument('-L','--label_path',type=str,required=True,help='Path to train_val pkl file')
parser.add_argument('--weights',type=str,required=True,help='Path to Resnet cholec80 weights')
# Default Configs
...
def train_model(train_dataset, train_num_each, val_dataset, val_num_each):
    ...
    if not load_exist_LFB:
        ...
        model_LFB.load_state_dict(torch.load("./resnet_cholec80_weights.pkl"))
        ...
        if not os.path.exists("./LFB"):
            os.makedirs("./LFB")
        with open("./LFB/g_LFB_train0.pkl", 'wb') as f:
            pickle.dump(g_LFB_train, f)
        with open("./LFB/g_LFB_val0.pkl", 'wb') as f:
            pickle.dump(g_LFB_val, f)
        with open("./LFB/g_LFB_test0.pkl", 'wb') as f:
