    ...
    if opt_config in ["standard"]:
        ...
        if dt_global:
            ssm_fn = map_nested_fn(
                lambda k, _: "ssm"
                if k in ["B", "Lambda_re", "Lambda_im", "norm", "E"]
            ...
            ssm_fn = map_nested_fn(
                lambda k, _: "ssm"
                if k in ["B", "Lambda_re", "Lambda_im", "log_step", "norm", "E"]
                else ("none" if k in [] else "regular")
            )
        ...
        if dt_global:
            ssm_fn = map_nested_fn(
                lambda k, _: "ssm"
                if k in ["Lambda_re", "Lambda_im", "norm", "E"]
            ...
            ssm_fn = map_nested_fn(
                lambda k, _: "ssm"
                if k in ["Lambda_re", "Lambda_im", "log_step", "norm", "E"]
                else ("none" if k in ["B"] else "regular")
            )
        tx = optax.multi_transform(
            {
