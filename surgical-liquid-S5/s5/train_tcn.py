...
train_labels_80, train_num_each_80, train_start_vidx,\
    ...
    test_labels_80, test_num_each_80, test_start_vidx = get_data('/home/ppak/surgical_ncp/train_val_paths_labels1.pkl')




with open("/home/ppak/surgical_ncp/LFB/g_LFB50_train0.pkl", 'rb') as f:
    g_LFB_train = pickle.load(f)
with open("/home/ppak/surgical_ncp/LFB/g_LFB50_val0.pkl", 'rb') as f:
    g_LFB_val = pickle.load(f)
with open("/home/ppak/surgical_ncp/LFB/g_LFB50_test0.pkl", 'rb') as f:
...
if not os.path.exists("./best_model/tcn/"):
    os.makedirs("./best_model/tcn/")
torch.save(best_model_wts, "./best_model/tcn/" + model_name + "_weights" + ".pth")
